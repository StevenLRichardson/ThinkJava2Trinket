...
%slr:  1-3-20: place trinket here which runs the stuff in this section
...
%slr:  1-3-20: Section exercise:  modify above trinket so that it has these public static final arrays 
...
%slr:  insert trinket.  implement code above with if-else and ask in a Section Exercise that they implement it as above

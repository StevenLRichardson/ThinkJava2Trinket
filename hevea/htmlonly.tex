...
%commented out slr 5/24/19 in an effort to get header and footer stuff out of rendered html
%\htmlhead{\rawhtmlinput{hevea/header.html}}

%\htmlfoot{\rawhtmlinput{hevea/footer.html}}
...
{\lstset{numbers=left}\minipage{\linewidth}}
{\endminipage}
{}

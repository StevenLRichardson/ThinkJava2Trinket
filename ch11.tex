...
%slr: 12-25-19
The individual houses are objects; the blueprint is the class.
%slr: end 12-25-19
...
%slr: 12-25-19
Here is a trinket implemetation of what we have so far:

% height = 130 + 11 * num_lines
\begin{trinket} [330] {Time.java}
public class Time {
    //class attributes
    private int hour;
    private int minute;
...
\begin{enumerate}
\item Does the above trinket \java{Time} compile successfully?
\item Does the above trinket \java{Time} run successfully?  If so, what is the output?
\item Modify the the above trinket \java{Time} so as to print out object \java{time}'s \java{hour} instance variable.  What do you get?  Why?
\item What small change to the delaration of the class attribute \java{hour} can you make to deal with the error above?  Make it and see what happens.
\end{enumerate}
%slr: end 12-25-19
...
%slr: 12-25-19
Here is a trinket implemetation of what we have now:
% height = 130 + 11 * num_lines
\begin{trinket} [430] {Time.java}
public class Time {
    //class attributes
    private int hour;
    private int minute;
...
%slr: 12-25-19
This is what we have seen in the trinkets above.
%slr: end 12-25-19
...
%slr: 12-25-19 
We tried this in the section exercises.
%slr: end 12-25-19
...
%slr: 12-25-19
Here is a trinket implemetation with getters, showing their use in \java{main}:

% height = 130 + 11 * num_lines
\begin{trinket} [600] {Time.java}
public class Time {
    //class attributes
    private int hour;
    private int minute;
    ...
    public static void main(String[] args) {
       ...
       System.out.println("time's hour instance variable has value: " + hour);
    }
}
\end{trinket}
...
If we decide that \java{TimeClient} should also be able to \textit{modify} the instance variables of \java{Time}, we can provide methods to do that, too:
...
\textbf{Section Exercises:}
\begin{enumerate}
\item Modify the the above trinket \java{Time} so as to print out object \java{time}'s \java{minute} and \java{second} instance variables in a nicely formatted way.
\item Modify the the above trinket \java{Time} adding the mutators (or setters) for each instance variable.  Then modify object \java{time}'s \java{hour}, \java{minute} and \java{second} instance variables and print them out, as in exercise 1, to see the results.
\end{enumerate}
%slr: end 12-25-19
...
%slr: 12-25-19
Here is a trinket implemetation which provides the \java{printTime} method and invokes it in \java{main}:

% height = 130 + 11 * num_lines
\begin{trinket} [680] {Time.java}
public class Time {
    //class attributes
    private int hour;
    private int minute;
    ...
    //static method for printing a nicely formatted Time ojects
    public static void printTime(Time t) {
       System.out.printf("%02d:%02d:%04.1f\n",
           t.hour, t.minute, t.second);
    }
    ...
    public static void main(String[] args) {
       Time time = new Time(11, 59, 59.9);
       //print out time using the new method
       printTime(time);
    }
}
\end{trinket}
...
Here is a trinket implemetation which provides the \java{toString} method and invokes it implicitly as in the code example immediately above:
...
\textbf{Section Exercises:}
\begin{enumerate}
\item Modify the above trinket \java{Time} (with the \java{toString} method) to include an \java{equals} method as described in this section.  Write statements in \java{main} to test your equals method and contrast it with the result of the \java{==} operator as shown in this section.
\end{enumerate}
%slr: end 12-25-19
...
\textbf{Section Exercises:}
\begin{enumerate}
\item Further modify the above trinket \java{Time} to which you added an \java{equals} method to now include the 'better' \java{add} \textbf{instance} method from the code example immediately above.  Write statements in \java{main} to test your new \java{add} method.
\end{enumerate}
%slr: end 12-25-19

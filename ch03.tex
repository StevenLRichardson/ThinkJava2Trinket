...
%slr: 8-13-19 replace with trinket object
%\begin{code}
...
\begin{trinket} [190] {PrintSystem.java}
public class PrintSystem {

    public static void main(String[] args) {
       System.out.println(System.out);  //what will we get?!
    }
}
\end{trinket}

Run the trinket. What do you get? Something like:
...
%slr: 8-13-19
% height = 130 + 11 * num_lines
\begin{trinket} [295] {Convert1.java}
import java.util.Scanner;
...
public class Convert1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("How many inches? ");
        inch = in.nextInt();
        cm = inch * 2.54;  //where does 2.54 come from?!
        System.out.print(inch + " in = ");
        System.out.println(cm + " cm");
    }
}
...
%slr: 8-13-19
\textbf{Section Exercise:}
\begin{enumerate}
\item Change the \java{Convert1} class in the trinket above to reflect the above change - replace the magic number 2.54 with the \java{final double} constant.  Make sure the program works the same.
\end{enumerate}
%slr: end 8-13-19
...
%slr: 8-13-19
Here is another try at the \java{Convert} program:
% height = 130 + 11 * num_lines
\begin{trinket} [295] {Convert2.java}
import java.util.Scanner;
...
Run it and see what you get.  We are slowly improving the \java{Convert} class.
%slr: end 8-13-19
...
%slr: 8-13-19
Here a version of the \java{Convert} program that converts the other way - from centimeters to inches:
% height = 130 + 11 * num_lines
\begin{trinket} [295] {Convert3.java}
import java.util.Scanner;
...
\begin{trinket} [450] {Convert.java}
import java.util.Scanner;
...
%\end{stdout}
The following Java class asks the user for their name and age:
% height = 130 + 11 * num_lines
\begin{trinket} [295] {NameAge.java}
import java.util.Scanner;
...
Run it and see what you get.  This appears to work the way we want it to.  
%slr: end 8-13-19
...
%\end{code}
% height = 130 + 11 * num_lines
\begin{trinket} [295] {AgeName.java}
import java.util.Scanner;
...
% height = 130 + 11 * num_lines
\begin{trinket} [295] {AgeName2.java}
import java.util.Scanner;

public class AgeName2 {
